          ...
          <div className="row align-items-center">
            <div className="col-xl-12">
              <div className="tpdesign-hero text-center">
                ...
                <span className="tpdesign-sub-title pt-170 mb-120 ">¡Hola! 👋 Somos SKOG</span>
                <h2 className="tpdesign-title pb-120 mb-200">Especialistas en fertilizantes <br />  y biotecnología</h2>
