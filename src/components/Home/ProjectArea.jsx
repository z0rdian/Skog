...
const ProjectArea = () => {
  return (
    <>
      <section
        id="fertilizantes"
        className="tpproject-area pb-110 pt-60 p-relative"
      >
            ...
            <div className="col-xl-12">
              <div className="tp-test-main-wrapper tp-arrow-style tp-dot-style p-relative">
                <div className="tp-slide-active pt-50">
                  <Swiper
                    navigation={{
                      nextEl: ".tp-slick-next",
                      prevEl: ".tp-slick-prev",
                    }}
                ...
                <div>
                  <button type="button" className="tp-slick-prev swiper-arrow">
                    <i className="far fa-long-arrow-left"></i>
                  </button>
                  <button type="button" className="tp-slick-next swiper-arrow">
