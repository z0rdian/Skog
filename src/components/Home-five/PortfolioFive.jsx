          ...
          <div className="row mt-60">
            <div className="col-xl-12">
              <div className="tpproject__menu text-center filter-button-group mb-40">
                ...
                <button
                  className={active === "WEB DESIGN" ? "active" : ""}
                  onClick={() => handleFilterItems("WEB DESIGN")}
                >
                  {" "}
                  WEB DESIGN <span className="count-number">2</span>{" "}
                </button>
                <button
                  className={active === "WEBSITE DESIGN" ? "active" : ""}
                  onClick={() => handleFilterItems("WEBSITE DESIGN")}
                >
                  WEBSITE DESIGN <span className="count-number">2</span>{" "}
                </button>
                <button
                  className={active === "APP DESIGN" ? "active" : ""}
                  onClick={() => handleFilterItems("APP DESIGN")}
                >
                  APPS <span className="count-number">2</span>{" "}
                </button>
                <button
                  className={active === "LANDING PAGE" ? "active" : ""}
                  onClick={() => handleFilterItems("LANDING PAGE")}
                >
                  LANDING PAGE <span className="count-number">2</span>{" "}
                </button>
                <button
                  className={active === "BRANDING DESIGN" ? "active" : ""}
                  onClick={() => handleFilterItems("BRANDING DESIGN")}
                >
                  BRANDING DESIGN <span className="count-number">2</span>{" "}
                </button>
              </div>
            </div>
          </div>
