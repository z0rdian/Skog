    ...
    <>
      <header>
        <div className="tp-header-area tp-header-3 box-plr-155">
          <div
            className={`tp-header-area-inner ${
            ...
            <div className="container-fluid">
              <div className="mega-menu-wrapper">
                <div className="row align-items-center">
                        ...
                        <ul>
                          <li className="has-dropdown">
                            ...
                            <ul className="submenu">
                              ...
                              <li>
                                <Link href="/home-eleven">
                                  Home Photographer 3
                                </Link>
                              </li>
                              <li>
                                <Link href="/home-twelve">
                                  Home Photographer 4
                                </Link>
                              </li>
                              <li>
                                <Link href="/home-thirteen">
                                  Home Politician
                                </Link>
                              </li>
                            </ul>
                            ...
                            <ul className="megamenu">
                              <li>
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <Link href="/error-page">Error 404</Link>
                                  </li>
                                  <li>
                              ...
                              <li>
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <Link href="/portfolio-two">
                                      Portfolio 2
                                    </Link>
                                  </li>
                                  <li>
                                    <Link href="/portfolio-three">
                                      Portfolio 3
                                    </Link>
                                  </li>
                                  <li>
                                    <Link href="/portfolio-four">
                                      Portfolio 4
                                    </Link>
                                  </li>
                                  <li>
                              ...
                              <li>
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <Link href="/services-two">Services 2</Link>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    <Link href="/team-two">Team 2</Link>
                                  </li>
                                  <li>
                                    <Link href="/about-me">Team Details</Link>
                                  </li>
                                </ul>
                              </li>
                              <li>
                  ...
                  <div className="col-xxl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                    <div className="logo-dark tp-model-logo">
                      <Link href="/">
                        <a>
                    ...
                    <div className="logo-white text-center">
                      <Link href="/">
                        <a>
