          ...
          <div className="row align-items-center">
            <div className="col-xl-5 col-lg-6">
              <div className="aboutme-image mb-40">
                <img
                  className="b-radius"
                  src="assets/img/project/project-d.jpg"
                  alt="project img"
                />
              </div>
            </div>
              ...
              <div className="aboutme-wrapper mb-40">
                <div className="aboutme-content">
                  <h3 className="tpabout-xd-title mb-50">
                    <b>Banking App Design &</b> Development
                  </h3>
                </div>
            ...
            <div className="col-xl-12">
              <div className="project-details-content">
                <h4 className="tab-pane-title mb-30">
                  <b>Something about</b> project Case Studies
                </h4>
                <p>
              ...
              <div className="row mt-45">
                <div className="col-xl-6 col-lg-6 col-md-6">
                  <div className="project-details-dimage w-img mb-45">
                    <img
                      className="b-radius"
                      src="assets/img/project/project-d2.jpg"
                      alt="project img"
                    />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6">
                  <div className="project-details-dimage w-img mb-45">
                    <img
                      className="b-radius"
                      src="assets/img/project/project-d3.jpg"
                      alt="project img"
                    />
                  </div>
                </div>
