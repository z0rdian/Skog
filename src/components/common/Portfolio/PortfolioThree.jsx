...
const PortfolioThree = ({ padd }) => {
  ...
  return (
    <>
      <div
        className={`tp-creative-lists-area tp-creative-padding ${
          padd ? padd : ""
        } pb-140`}
      >
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-creative__menu tp-creative__menu-grid text-center filter-button-group mb-70">
                ...
                <button
                  className={`tp-cr-btn ${active === "WEB DESIGN" && "active"}`}
                ...
                <button
                  className={`tp-cr-btn ${active === "APPS" && "active"}`}
                  onClick={() => handleFilterItems("APPS")}
                >
                  APPS
                </button>
