...
const PortfolioFour = ({ padd }) => {
  ...
  return (
    <>
      <div
        id="tp-creative"
        className={`tp-creative-lists-area ${padd ? padd : "pt-50 pb-140"}`}
      >
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-creative__menu tp-creative__menu-grid tp-creative__menu-curve text-center filter-button-group mb-80">
                <button
                  className={`tp-cr-btn ${active === "all" && "active"}`}
                ...
                <button
                  className={`tp-cr-btn ${active === "WEDDING" && "active"}`}
                ...
                <button
                  className={`tp-cr-btn ${
                    active === "BIRTHDAY PARTY" && "active"
                  }`}
                  onClick={() => handleFilterItems("BIRTHDAY PARTY")}
                >
                  BIRTHDAY PARTY
                </button>

                <button
                  className={`tp-cr-btn ${active === "EVENTS" && "active"}`}
                ...
                <button
                  className={`tp-cr-btn ${
                    active === "PRINT DESIGN" && "active"
                  }`}
                  onClick={() => handleFilterItems("PRINT DESIGN")}
                >
                  PRINT DESIGN
                </button>

                <button
                  className={`tp-cr-btn ${active === "3D DESIGN" && "active"}`}
                  onClick={() => handleFilterItems("3D DESIGN")}
                >
                  3D DESIGN
                </button>
                ...
                <button
                  className={`tp-cr-btn ${
                    active === "PRODUCT DESIGN" && "active"
                  }`}
                  onClick={() => handleFilterItems("PRODUCT DESIGN")}
                >
                  PRODUCT DESIGN
                </button>
              </div>
