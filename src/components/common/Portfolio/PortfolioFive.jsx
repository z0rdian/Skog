...
const PortfolioFive = () => {
  ...
  return (
    <>
      <div
        id="tp-creative"
        className="tp-creative-lists-area tp-creative-padding pt-200 pb-140"
      >
          ...
          <div className="row ">
            <div className="col-xl-12">
              <div className="tpproject__menu text-center filter-button-group mb-70">
                ...
                >
                  All <span className="count-number">09</span>
                </button>

                <button
                  className={active === "TRAVEL" ? "active" : ""}
                  onClick={() => handleFilterItems("TRAVEL")}
                >
                  TRAVEL<span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "PRODUCT" ? "active" : ""}
                  onClick={() => handleFilterItems("PRODUCT")}
                >
                  PRODUCT<span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "BRANDING" ? "active" : ""}
                  onClick={() => handleFilterItems("BRANDING")}
                >
                  BRANDING <span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "MINIMAL" ? "active" : ""}
                  onClick={() => handleFilterItems("MINIMAL")}
                >
                  MINIMAL<span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "ADVENTURE" ? "active" : ""}
                  onClick={() => handleFilterItems("ADVENTURE")}
                >
                  ADVENTURE<span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "WEDDING" ? "active" : ""}
                  onClick={() => handleFilterItems("WEDDING")}
                >
                  WEDDING<span className="count-number">03</span>{" "}
                </button>

                <button
                  className={active === "EVENTS" ? "active" : ""}
                  onClick={() => handleFilterItems("EVENTS")}
                >
                  EVENTS<span className="count-number">02</span>{" "}
                </button>
              </div>
            </div>
          </div>
                    ...
                    >
                      <div className="tppg-project mb-30">
                        ...
                        <div className="tppg-project__content">
                          <span className="tppg-project-tag mb-10">
                            {item.category}
                          </span>
